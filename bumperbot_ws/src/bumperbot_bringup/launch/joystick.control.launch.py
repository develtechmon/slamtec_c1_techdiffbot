...
def generate_launch_description():
    ...
    package_name = get_package_share_directory('bumperbot_bringup')
    ...
    launch_arguments={
        ...
        "config_locks": os.path.join(package_name, "config", "twist_mux_locks.yaml"),
        "config_topics": os.path.join(package_name, "config", "twist_mux_topics.yaml"),
        "config_joy": os.path.join(package_name, "config", "twist_mux_joy.yaml"),
        "use_sim_time": LaunchConfiguration("use_sim_time"),
    }.items(),
    )
